...
export default function Home(){
    return(
        ...
        <div className="h-[769px] flex flex-col md:h-[630px] md:flex-row w-full bg-[#211C24] p-0 m-0" >
            <div className="w-full pl-0 text-center md:text-left md:w-[60%] md:pl-40">
                ...
                <Link href="/Phone">
                    <button className='btn mt-[25px] text-white border-2 h-[56px] w-[191px] rounded-md'> Shop Now</button>
                </Link>
            </div>
    ...
    <div className="second-section flex h-[600px]">   
        <div className="left-second">
            <div className="top h-[328px] flex w-[720px]">
                <div className="image-top zoom"></div>
                <div>
            ...
            <div className="bottom1 flex w-[360px] h-[272px]  bg-[#EDEDED]">
                <div className="image-btm1 zoom"></div>
                <div>
            ...
            <div className="bottom2 flex w-[360px] h-[272px]  bg-[#353535]">
                <div className="image-btm2 zoom"></div>
                <div>
        ...
        <div className="right-second flex w-[720px] h-[600px] bg-[#EDEDED]">
            ...
            <button className='blackButton mt-[25px] border-black text-black border-2 h-10 w-[151px] rounded-md'>Shop Now</button>

            </div>
            <div className="image-right zoom "></div>
        ...
        <div className="categeory flex justify-evenly  w-full h-40 pl-[160px] pr-[160px] "> 
                ...
                {cateData.map((data)=>(
                    <div >
                     ...
                     <Image className='zoom' src={data.picture} alt={data.tittle} width={48} height={48} />
                     </div>
    ...
    <div className="forth-section w-full h-[1106px]">
        ...
        <div className="product-section flex  ml-[120px] mr-[120px] mt-[62px] justify-between flex-wrap">
                ...
                <div className="product w-[268px] h-[432px] bg-[#F6F6F6] rounded mt-[16px]">
                    ...
                    <Image className='zoom' src={proData.proImg} alt="image of phone"></Image>
                    </div>
    ...
    <div className="fifth-section flex w-full h-[640px]">
                ...
                {popular.map((popularData,index)=>(
                      ...
                      <div className='h-[327px] w-[330px] ' >
                        <Image className='zoom' src={popularData.img} alt='pic' height={327} width={360}></Image>
                      </div>
                      ...
                      <button className='zoom border-2 border-black w-[191px] h-[56px] rounded-md mt-[16px] ml-[32px]' key={index} style={{color: btn[index % colors.length], borderColor: btn [index % colors.length] }}>Shop Now</button>
                  </div>    
    ...
    <div className="sixth-section">
        ...
        {discount.map((discountData)=>(
                <div className="product w-[268px] h-[432px] bg-[#F6F6F6] rounded mt-[16px] ml-[16px]">
                    ...
                    <div className="pro-img h-[160px] w-[160px] mt-[60px] ml-[60px]">
                    <Image className='zoom' src={discountData.picture} alt="image of phone"></Image>
                    </div>
    ...
    <div className="seventh-section">
        ...
        <button className=' zoom mt-[25px] text-white border-2 h-10 w-[151px] rounded-md ml-[570px]'>Shop Now</button>
    </div>
    <Footer/>
    </div>
    )
